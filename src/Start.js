  ...
  render() {
    return (
      <div id="start" className={this.props.startActive ? "start" : "start hidden"}>
        ...
        <button className="start__button" onClick={(e) => { this.props.toggleStart(); this.props.togglePlay() }}><img src="./images/alien1.svg" alt="Alien 1" width="20" height="14" /> START GAME</button>
